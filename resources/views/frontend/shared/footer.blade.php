        ...
        <div class="custom-footer-top">
            <div class="footer__container">
                <div class="custom-footer-top-wrap">
                    <div class="custom-footer-menu"> <span id="hs_cos_wrapper_my_menu" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_menu" style="" data-hs-cos-general-type="widget" data-hs-cos-type="menu">
                    ...
                    <div class="custom-footer-social">
                        <div class="custom-ft-get">
                            <div id="hs_cos_wrapper_get_in_touch" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                <div class="custom-footer-get-in-touch"> <b>{{__('footer.text_18')}}</b>  <span class="d-flex text-nowrap mt-2 align-items-center"> <i class="material-icons no-select mr-1">mail_outline</i>
                                        <a onclick="sendEvent('Contact', 'click-footer-mailto-info@ethicalresearchsolution.com');" class="text-white" href="mailto:info@ethicalresearchsolution.com">info@ethicalresearchsolution.com</a> </span>
                                    <span class="d-flex text-nowrap mt-2 align-items-center"> <i class="material-icons no-select mr-1">phone</i> <a onclick="sendEvent('Contact', 'click-footer-tel-rwanda');" class="text-white" href="tel://+250782-121-650">
                                            <span class="d-block">Rwanda:</span> +250 782 121 650</a>
                                ...
                                <ul class="social">
                                    <li>
                                        <a target="_blank" href="https://www.linkedin.com/company/Ethical Research Solutions/">
                                            <img src="{{asset('/public/frontend/images/linkedin-1b895fedb7dbb2895972cd37e2d0896b00836410256d725f0eebf640f9fd77a1.svg')}}" alt="Linkedin" loading="lazy" style="max-width: 100%; height: auto;">
                                        </a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://twitter.com/EthicalResearchSolutions">
                                            <img src="{{asset('/public/frontend/images/twitter-cbea53834cedd7d3272b6ea42efe3c9eed3352eb68e96b8a2478f646087e1359.svg')}}" alt="Twitter" loading="lazy" style="max-width: 100%; height: auto;">
                                        </a>
                                    </li>
                                    <li class="d-inline-block">
                                        <a target="_blank" href="https://www.facebook.com/EthicalResearchSolutions">
                                            <img src="{{asset('/public/frontend/images/facebook-1f927c18c597b1a6c4e921b8dec804f8f2df5e46f9e332c3c20a0c7b3d23ecb7.svg')}}" alt="Facebook" loading="lazy" style="max-width: 100%; height: auto;">
                                        </a>
                                    </li>
                                    <li>
                                        <a target="_blank" href="https://www.instagram.com/Ethical Research Solutions/">
                                            <img src="{{asset('/public/frontend/images/instagram-d24e0db3e2d23630ba2cf3b5c8c484f1fda33623c953c43af662ec848de63437.svg')}}" alt="Instagram" loading="lazy" style="max-width: 100%; height: auto;">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="custom-footer-bottom-wrap">
                    <div class="custom-footer-image ft-bottom-col">
                        <div id="hs_cos_wrapper_linked_image1" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                            <span id="hs_cos_wrapper_linked_image1_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="linked_image"><a href="/"></a></span>
                        </div>
                        <div id="hs_cos_wrapper_linked_image2" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                            <span id="hs_cos_wrapper_linked_image2_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="linked_image"><a href="/"></a></span>
                        </div>
                    </div>
                    <div class="custom-footer-image2 ft-bottom-col">
                        <div id="hs_cos_wrapper_footer_block1" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                            <span id="hs_cos_wrapper_footer_block1_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
                                <p> A Trusted Research Partner</p></span>
                        </div>
                    </div>
...
{{--                                        @endforeach--}}
                                    ...
                                    <div class="header__language-switcher--label-current">{{session()->get('locale')}}</div>
    ...
    <div class="custom-footer-mobile">
        <div class="custom-footer-top">
            <div class="custom-footer-top-wrap">
                <div class="custom-footer-menu"> <span id="hs_cos_wrapper_my_menu" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_menu" style="" data-hs-cos-general-type="widget" data-hs-cos-type="menu">
                        <div id="hs_menu_wrapper_my_menu" class="hs-menu-wrapper active-branch flyouts hs-menu-flow-horizontal" role="navigation" data-sitemap-name="default"  aria-label="Navigation Menu">
                            <ul><li class="hs-menu-item hs-menu-depth-1 hs-item-has-children" role="menu">
                                ...
                                <li class="hs-menu-item hs-menu-depth-1 hs-item-has-children" role="menu">
                                    <a href="javascript:;" aria-haspopup="true" aria-expanded="false" role="menuitem">Get in touch</a><ul class="hs-menu-children-wrapper">
                                        <li class="hs-menu-item hs-menu-depth-2" role="menuitem">
                                            <a href="mailto:info@ethicalresearchsolution.com" role="menuitem">info@ethicalresearchsolution.com</a></li>
                            ...
                            <div class="header__language-switcher--label">
                                <div id="hs_cos_wrapper_language-switcher" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-language_switcher" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                    <span id="hs_cos_wrapper_language-switcher_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_language_switcher" style="" data-hs-cos-general-type="widget" data-hs-cos-type="language_switcher">
                                        <div class="lang_switcher_class"><div class="globe_class" onclick="">
								<ul class="lang_list_class">
                                    <select class="form-control changeLang lang_switcher_link">
                                        <li>  <option class="lang_switcher_link" value="en" {{ session()->get('locale') == 'en' ? 'selected' : '' }}>English</option></li>
                                        <option class="lang_switcher_link" value="fr" {{ session()->get('locale') == 'fr' ? 'selected' : '' }}>France</option>
                                        <option class="lang_switcher_link" value="pt" {{ session()->get('locale') == 'pt' ? 'selected' : '' }}>Portugal</option>
                                    </select>
{{--								@foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)--}}
{{--                                        <li> <a class="lang_switcher_link" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">{{ $properties['native'] }}</a></li>--}}
{{--                                    @endforeach--}}
